// GET https://example.com/oauth/google/callback?code=AUTHORIZATION_CODE
...
const storedCodeVerifier = todo.getRequestCookie("google_oauth_code_verifier");

if (authorizationCode === null || storedCodeVerifier === null) {
...
accessTokenRequestBody.set("code_verifier", storedCodeVerifier);
